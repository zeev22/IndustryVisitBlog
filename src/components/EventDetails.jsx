...
import D1c from '../assets/D1/D1c.jpg';
...
import D1h from '../assets/D1/D1h.jpg';
...
import D1r from '../assets/D1/D1r.jpg';
import D1s from '../assets/D1/D1s.jpg';
...
const generateImageArrays = (day) => {
  const images = {
    1: [D1a, D1b, D1c, D1d, D1e, D1f, D1g, D1h, D1i, D1j, D1k, D1l, D1m, D1n, D1o, D1p, D1q, D1r, D1s, D1t, D1u, D1v, D1w, D1x],
...
// Define events with updated descriptions
const events = [
  {
    id: 1,
    ...
    date: 'April 7, 2025',
    description: 'Our first day was a vibrant exploration of Manila’s historical and modern landmarks. From the cobblestone streets of Intramuros to the serene Rizal Park, we delved into the city’s rich heritage. Visits to Manila Cathedral and San Agustin Church offered insights into cultural traditions, while a stop at Mall of Asia showcased Manila’s bustling urban life.',
    shortDescription: 'A cultural and modern adventure in Manila.',
  ...
  },
  {
    ...
    date: 'April 8, 2025',
    description: 'We explored cutting-edge maritime technology at Subic Bay’s Vessel Traffic Management System and SBECC. The visit provided a deep dive into how advanced systems ensure safe and efficient port operations, offering valuable insights into the intersection of technology and logistics.',
    shortDescription: 'A glimpse into maritime technology at Subic Bay.',
    ...generateImageArrays(2),
  },
  {
    id: 3,
    title: 'Day 3: Museum Visit',
    location: 'National Museum of Natural History, Museo ni Manuel Quezon',
    date: 'April 9, 2025',
    description: 'This day was dedicated to cultural enrichment with visits to the National Museum of Natural History and Museo ni Manuel Quezon. We explored exhibits showcasing the Philippines’ biodiversity and historical legacy, gaining a deeper appreciation for the nation’s heritage.',
    shortDescription: 'A cultural journey through Manila’s museums.',
  ...
  },
  {
    ...
    date: 'April 10, 2025',
    description: 'We visited Bangko Sentral ng Pilipinas and HYTEC Power Inc., gaining insights into financial systems and innovative energy solutions. The experience highlighted the role of technology in driving economic and environmental progress.',
    shortDescription: 'Exploring finance and energy innovation.',
  ...
  },
  {
    ...
    date: 'April 11, 2025',
    description: 'This day focused on urban mobility, with visits to LRT2 and the Metropolitan Manila Development Authority (MMDA). We learned about public transportation systems and traffic management, understanding the infrastructure that keeps Manila moving.',
    shortDescription: 'A look at Manila’s urban mobility systems.',
  ...
  },
  {
    ...
    date: 'April 12, 2025',
    description: 'We ventured to Baguio, visiting the Philippine Military Academy, Strawberry Farm, Bell Church, Mines View Park, and The Mansion. The blend of natural beauty, cultural landmarks, and historical sites offered a refreshing perspective on the City of Pines.',
    shortDescription: 'A scenic and cultural escape to Baguio.',
  ...
  },
  {
    ...
    date: 'April 13, 2025',
    description: 'Our final day in Baguio included visits to the lively Baguio Public Market and the serene Burnham Park. These iconic spots showcased the city’s vibrant community and tranquil green spaces, capping off our industrial visit with memorable experiences.',
    shortDescription: 'A vibrant farewell to Baguio’s charm.',
      ...
      <div className="event-details-content">
        ...
        <div className="event-details-body">
          <div className="event-details-image-overlay">
            ...
            <p className="event-details-description-overlay">{event.description}</p>
          </div>
          ...
          <img src={event.images[3]} alt="After paragraph 2" className="event-details-image-after" onError={(e) => { e.target.src = '/fallback-image.jpg'; }} />
        </div>
